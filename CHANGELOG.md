...
- **HTTP/2 and HTTP/3 implementations**: HTTP/2 and HTTP/3 functionality in Ferron now depends on `vibeio-http`'s in-house protocol implementations instead of `h2` and `h3` from Hyperium.
