...
use ferron_http_cgi::CgiModuleLoader;
use ferron_http_fauth::ForwardedAuthenticationModuleLoader;
use ferron_http_fcgi::FcgiModuleLoader;
use ferron_http_scgi::ScgiModuleLoader;
...
use ferron_http_buffer::HttpBufferModuleLoader;
...
fn get_loaders() -> Vec<Box<dyn ModuleLoader>> {
    vec![
        ...
        Box::new(HttpRateLimitModuleLoader),
        Box::new(HttpResponseModuleLoader),
        Box::new(HttpRewriteModuleLoader),
        Box::new(HttpMapModuleLoader),
        ...
        Box::new(CgiModuleLoader),
        Box::new(ScgiModuleLoader),
        Box::new(FcgiModuleLoader::default()),
        ...
        Box::new(PrometheusObservabilityModuleLoader::default()),
