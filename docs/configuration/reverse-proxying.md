...
- `upstream <url: string>` (`ferron-http-proxy`)
...
- `srv <name: string>` (`ferron-http-proxy`; requires `srv-lookup` feature)
...
- `lb_algorithm <algorithm: string>` (`ferron-http-proxy`)
...
- `lb_health_check [bool: boolean]` (`ferron-http-proxy`)
...
- `lb_health_check_max_fails <count: integer>` (`ferron-http-proxy`)
...
- `lb_health_check_window <duration: string>` (`ferron-http-proxy`)
...
- `lb_retry_connection [bool: boolean]` (`ferron-http-proxy`)
...
- `keepalive [bool: boolean]` (`ferron-http-proxy`)
...
- `http2 [bool: boolean]` (`ferron-http-proxy`)
...
- `http2_only [bool: boolean]` (`ferron-http-proxy`)
...
- `intercept_errors [bool: boolean]` (`ferron-http-proxy`)
...
- `no_verification [bool: boolean]` (`ferron-http-proxy`)
...
- `proxy_header <version: string>` (`ferron-http-proxy`)
...
- `request_header` (`ferron-http-proxy`)
