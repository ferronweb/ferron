...
See [JSON configuration and adapt command](/docs/v3/configuration/json-config) for details.
...
- [JSON configuration and adapt command](/docs/v3/configuration/json-config)
