...
4. Move on to [Configuration syntax](/docs/v3/configuration/fundamentals/syntax) and the related directive pages when you want directive-level details.

## Good next reads

- [Configuration syntax](/docs/v3/configuration/fundamentals/syntax)
