...
- Read [Architecture](/docs/v3/module-development/architecture) to learn how
  the server orders stages and manages runtimes.

## Where to go next

- [Architecture](/docs/v3/module-development/architecture): how Ferron starts, how the pipeline runs, and how the two runtimes work.
- [Creating a module](/docs/v3/module-development/creating-a-module): step-by-step guide to write a `ModuleLoader` crate.
- [Module API](/docs/v3/module-development/module-api): introduction to the traits you implement.
- [Naming conventions](/docs/v3/module-development/naming-conventions): how to name directives and crates.
- [Example modules](/docs/v3/module-development/examples): runnable examples you can copy.
- [Obtaining API docs](/docs/v3/module-development/obtaining-api-docs): how to generate local Rust docs for `ferron-core` and `types/*`.
