...
- For complex logic (method/header/path combinations), use conditional configuration. See [Configuration: conditionals](/docs/v2/configuration/conditionals).
- For directive details (`status`, `user`, `allow`, `block`, `trust_x_forwarded_for`), see [Configuration: security & TLS](/docs/v2/configuration/security-tls).
