...
- [Core directives](/docs/v3/configuration/core-directives) — full admin block configuration reference.
...
- [Reverse proxying](/docs/v3/use-cases/reverse-proxy) — front the admin API with an authenticating reverse proxy.
