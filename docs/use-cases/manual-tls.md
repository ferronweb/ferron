...
- For all TLS-related directives (`tls`, `tls_min_version`, `tls_max_version`, `tls_client_certificate`, `ocsp_stapling`), see [Configuration: security & TLS](/docs/v2/configuration/security-tls).
