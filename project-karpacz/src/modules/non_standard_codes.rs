...
use crate::project_karpacz_util::non_standard_code_structs::{
  NonStandardCode, NonStandardCodesWrap,
};
              ...
              header_map.insert(
                ...
                HeaderValue::from_str(&format!(
                  ...
                  non_standard_code
                    .realm
                    .clone()
                    .unwrap_or("Project Karpacz HTTP Basic Authorization".to_string())
                    .replace("\\", "\\\\")
                    .replace("\"", "\\\"")
                ))?,
              );
