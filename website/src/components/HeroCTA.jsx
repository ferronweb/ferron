...
function HeroCTA() {
  ...
  useEffect(() => {
    const commands = {
      linux: 'sudo bash -c "$(curl -fsSL https://get.ferron.sh/v1)"',
      windows: 'powershell -c "irm https://get.ferron.sh/v1-win | iex"',
      docker:
        "docker pull ferronserver/ferron:1 && docker run --name myferron -d -p 80:80 --restart=always ferronserver/ferron:1"
    };
  ...
  return (
    <div className="hidden md:block">
      <div className="flex flex-row justify-start max-w-xl">
        <div className="grow overflow-hidden bg-accent text-accent-foreground rounded-md px-5 py-2 text-lg flex flex-row">
